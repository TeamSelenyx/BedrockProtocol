...
final class MemoryCategory{
	...
	public const ORE_UI_CLIENT = 54;
	public const PERSONA = 55;
	public const PLAYER = 56;
	public const RENDER_CHUNK = 57;
	public const RENDER_CHUNK_INDEX_BUFFER = 58;
	public const RENDER_CHUNK_VERTEX_BUFFER = 59;
	public const RENDERING = 60;
	public const RENDERING_LIBRARY = 61;
	public const REQUEST_LOG = 62;
	public const RESOURCE_PACKS = 63;
	public const SOUND = 64;
	public const SUB_CHUNK_BIOME_DATA = 65;
	public const SUB_CHUNK_BLOCK_DATA = 66;
	public const SUB_CHUNK_LIGHT_DATA = 67;
	public const TEXTURES = 68;
	public const VR = 69;
	public const WEATHER_RENDERER = 70;
	public const WORLD_GENERATOR = 71;
	public const TASKS = 72;
	public const TEST = 73;
	public const SCRIPTING = 74;
	public const SCRIPTING_RUNTIME = 75;
	public const SCRIPTING_CONTEXT = 76;
	public const SCRIPTING_CONTEXT_BINDINGS_MC = 77;
	public const SCRIPTING_CONTEXT_BINDINGS_GT = 78;
	public const SCRIPTING_CONTEXT_RUN = 79;
	public const DATA_DRIVEN_UI = 80;
	public const DATA_DRIVEN_UI_DEFS = 81;
}
